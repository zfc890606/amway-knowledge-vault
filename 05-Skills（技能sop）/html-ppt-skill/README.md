...
**License:** MIT
**中文文档:** [README.zh-CN.md](知识库/05-Skills（技能sop）/短视频方法库/html-ppt-skill/README.zh-CN.md)

![html-ppt — cover with live previews](hero.gif)
...
![Presenter mode with 4 magnetic cards](presenter-mode.png)
...
See [`references/presenter-mode.md`](presenter-mode.md) for the
...
![36 themes · 8 of them](themes.png)
...
![14 full-deck templates](templates.png)
...
![31 single-page layouts](layouts.png)
