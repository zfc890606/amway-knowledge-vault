...
See [references/presenter-mode.md](presenter-mode.md) for the full authoring guide including the 3 rules of speaker script writing:
...
2. **Pick a theme.** Open the deck and press `T` to cycle. Or hard-code it:
   ...
   ```
   Catalog in [references/themes.md](知识库/05-Skills（技能sop）/短视频方法库/html-ppt-skill/references/themes.md).
3. **Pick layouts.** Copy `<section class="slide">...</section>` blocks out of
   ...
   Catalog in [references/layouts.md](layouts.md).
4. **Add animations.** Put `data-anim="fade-up"` (or `class="anim-fade-up"`) on
   ...
   Catalog in [references/animations.md](animations.md).
5. **Use a full-deck template.** Copy `templates/full-decks/<name>/` into
   ...
   scoped CSS. Catalog in [references/full-decks.md](full-decks.md)
...
See [references/authoring-guide.md](authoring-guide.md) for a
...
- [references/themes.md](知识库/05-Skills（技能sop）/短视频方法库/html-ppt-skill/references/themes.md) — all 36 themes with when-to-use.
- [references/layouts.md](layouts.md) — all 31 layout types.
- [references/animations.md](animations.md) — 27 CSS + 20 canvas FX animations.
- [references/full-decks.md](full-decks.md) — all 15 full-deck templates.
- [references/presenter-mode.md](presenter-mode.md) — **演讲者模式 + 逐字稿编写指南（技术分享/演讲必看）**.
- [references/authoring-guide.md](authoring-guide.md) — full workflow.
