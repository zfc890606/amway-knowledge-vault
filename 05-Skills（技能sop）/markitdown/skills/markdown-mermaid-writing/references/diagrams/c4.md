...
**When NOT to use:** Infrastructure topology (use [Architecture](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/markdown-mermaid-writing/references/diagrams/architecture.md)), runtime sequences (use [Sequence](sequence.md))
