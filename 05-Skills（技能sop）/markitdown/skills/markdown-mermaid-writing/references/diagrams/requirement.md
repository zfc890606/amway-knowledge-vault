...
**When NOT to use:** Informal task tracking (use [Kanban](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/markdown-mermaid-writing/references/diagrams/kanban.md)), general relationships (use [ER](er.md))
