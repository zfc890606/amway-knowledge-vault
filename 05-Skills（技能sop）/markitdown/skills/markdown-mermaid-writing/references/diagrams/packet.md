...
**When NOT to use:** General data models (use [ER](er.md)), system architecture (use [C4](c4.md) or [Architecture](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/markdown-mermaid-writing/references/diagrams/architecture.md))
