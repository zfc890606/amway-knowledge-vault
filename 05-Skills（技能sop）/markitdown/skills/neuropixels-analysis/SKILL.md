...
[references/AUTOMATED_CURATION.md](AUTOMATED_CURATION.md) for details and the
...
See [references/AI_CURATION.md](AI_CURATION.md) for the full pattern (rendering a
...
| Topic | Reference |
|-------|-----------|
| Full workflow | [references/standard_workflow.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/neuropixels-analysis/references/standard_workflow.md) |
| API reference (SpikeInterface) | [references/api_reference.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/neuropixels-analysis/references/api_reference.md) |
| Plotting guide | [references/plotting_guide.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/neuropixels-analysis/references/plotting_guide.md) |
| Preprocessing | [references/PREPROCESSING.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/neuropixels-analysis/references/PREPROCESSING.md) |
| Spike sorting | [references/SPIKE_SORTING.md](SPIKE_SORTING.md) |
| Motion correction | [references/MOTION_CORRECTION.md](MOTION_CORRECTION.md) |
| Quality metrics | [references/QUALITY_METRICS.md](QUALITY_METRICS.md) |
| Automated & model-based curation | [references/AUTOMATED_CURATION.md](AUTOMATED_CURATION.md) |
| AI-assisted curation | [references/AI_CURATION.md](AI_CURATION.md) |
| Waveform analysis | [references/ANALYSIS.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/neuropixels-analysis/references/ANALYSIS.md) |
