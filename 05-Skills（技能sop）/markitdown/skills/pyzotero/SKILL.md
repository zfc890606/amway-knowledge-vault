...
See [references/authentication.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/pyzotero/references/authentication.md) for full setup details.
...
| File | Contents |
|------|----------|
| [references/authentication.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/pyzotero/references/authentication.md) | Credentials, library types, local mode |
| [references/read-api.md](read-api.md) | Retrieving items, collections, tags, groups |
| [references/search-params.md](search-params.md) | Filtering, sorting, search parameters |
| [references/write-api.md](write-api.md) | Creating, updating, deleting items |
| [references/collections.md](collections.md) | Collection CRUD operations |
| [references/tags.md](tags.md) | Tag access and management |
| [references/files-attachments.md](files-attachments.md) | File download and attachment uploads |
| [references/exports.md](exports.md) | BibTeX, CSL-JSON, bibliography export |
| [references/pagination.md](pagination.md) | follow(), everything(), generators |
| [references/full-text.md](full-text.md) | Full-text content indexing and access |
| [references/saved-searches.md](saved-searches.md) | Saved search management |
| [references/cli.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/pyzotero/references/cli.md) | Command-line interface (local Zotero 7) |
| [references/mcp.md](mcp.md) | MCP server for LLM clients (local Zotero 7) |
| [references/error-handling.md](error-handling.md) | Errors and exception handling |
...
For searching a locally running Zotero desktop app (including full-text PDF search), use the CLI or MCP server instead of the Web API. Both require Zotero 7 with local API access enabled. See [references/cli.md](知识库/05-Skills（技能sop）/短视频方法库/开发工具类/markitdown/skills/pyzotero/references/cli.md) and [references/mcp.md](mcp.md).
